...
def details():
    ...
    return render_template('details.html', temperature=temperature, humidity=humidity, pressure=pressure,
                           weather_description=weather_description, wind_speed=wind_speed, outfit=outfit, name=name,
                           city=city)
